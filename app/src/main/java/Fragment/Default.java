 ...
 * {@link Default.OnDefaultFragmentInteractionListener} interface
...
public class Default extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnDefaultFragmentInteractionListener(uri);
        }
    }
    ...
    public interface OnDefaultFragmentInteractionListener {
        ...
        void OnDefaultFragmentInteractionListener(Uri uri);
    }
}
