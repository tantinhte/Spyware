 ...
 * {@link image.OnImageFragmentInteractionListener} interface
...
public class image extends Fragment {
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnImageFragmentInteractionListener(uri);
        }
    }
    ...
    public interface OnImageFragmentInteractionListener {
        ...
        void OnImageFragmentInteractionListener(Uri uri);
    }
}
