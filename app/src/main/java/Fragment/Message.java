...
import Adapter.MessageTab;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link Message.OnMessageFragmentInteractionListener} interface
...
public class Message extends Fragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState){
        ...
        //prepare adapter
        MessageTab messageTab = new MessageTab(getChildFragmentManager());
        messageTab.addFragment(new MessageTabInbox(),"Inbox");
        messageTab.addFragment(new MessageTabSend(),"Send");
        messageTab.addFragment(new MessageTabDraft(),"Draft");

        //apply adapter
        viewPager.setAdapter(messageTab);
    }
    ...
    public void onButtonPressed(Uri uri) {
        if (mListener != null) {
            mListener.OnMessageFragmentInteractionListener(uri);
        }
    }
    ...
    public interface OnMessageFragmentInteractionListener {
        ...
        void OnMessageFragmentInteractionListener(Uri uri);
    }
